		...
		<form action="register">
			<table border="1" cellpadding="5">
				...
				<tr>
					...
					<td align="center" colspan="3">
						<input type="text" name="creditCardInformation" size="45" value="1234 5678 9101 1121" onfocus="this.value=''">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>Email: </th>
					<td align="center" colspan="3">
						<input type="text" name="example@wayne.edu" size="45" value="123-456-7890" onfocus="this.value=''">
					</td>
				</tr>
